...
class NutritionCombinedView: UIView {
    ...
    let caloriesIcon = UIImage(systemName: "flame.circle.fill") ?? UIImage(systemName: "questionmark.circle.fill")!
    let carbsIcon = UIImage(systemName: "laurel.trailing") ?? UIImage(systemName: "questionmark.circle.fill")!
    let proteinIcon = UIImage(systemName: "hare.fill") ?? UIImage(systemName: "questionmark.circle.fill")!
    let fatIcon = UIImage(systemName: "microbe.circle.fill") ?? UIImage(systemName: "questionmark.circle.fill")!
    
    init(nutrition: Nutrition) {
        caloriesView = NutritionView(icon: caloriesIcon, text: nutrition.calories, textAlignment: .left)
        carbsView = NutritionView(icon: caloriesIcon, text: nutrition.carbohydrates, textAlignment: .left)
        proteinView = NutritionView(icon: proteinIcon, text: nutrition.protein, textAlignment: .right)
        fatsView = NutritionView(icon: fatIcon, text: nutrition.fats, textAlignment: .right)
